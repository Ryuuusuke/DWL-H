...
static const char *const autostart[] = {
    ...
    "fill",
    "-i",
    "/home/ryusuke/Pictures/Wallpaper/liat-pesawat.jpg",
    NULL,
    "/usr/libexec/polkit-gnome-authentication-agent-1",
    NULL,
    "dbus-pdate-activation-environment",
    "WAYLAND_DISPLAY",
    "XDG_CURRENT_DESKTOP",
    NULL,
    "mako",
...
/*static const char *kbl_up[] = {
    "/usr/bin/light", "-s", "sysfs/leds/asus::kbd_backlight", "-U", "33.34",
   NULL}; */
static const char *light_up[] = {"/usr/bin/light", "-A", "2%", NULL};
static const char *light_down[] = {"/usr/bin/light", "-U", "2%", NULL};
static const char *kbl_up[] = {
    "/usr/bin/light", "-s", "sysfs/leds/asus::kbd_backlight", "-A",
    "33.34",          NULL};
static const char *kbl_down[] = {
    "/usr/bin/light", "-s", "sysfs/leds/asus::kbd_backlight", "-U",
    "33.34",          NULL};
...
static const char *screenshot[] = {
    "sh", "-c", "hyprshot -m region | wl-copy -p -t image/png", NULL};
...
static const Key keys[] = {
    ...
    //	{ MODKEY,                    XKB_KEY_comma,      setlayout,      {.v =
    ...
    //	{ MODKEY,                    XKB_KEY_period,     focusmon,       {.i =
    // WLR_DIRECTION_RIGHT} }, 	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_less,
    // tagmon,
    //{.i = WLR_DIRECTION_LEFT} }, 	{ MODKEY|WLR_MODIFIER_SHIFT,
    // XKB_KEY_greater, tagmon,         {.i = WLR_DIRECTION_RIGHT} },
    ...
    {0, XKB_KEY_XF86KbdBrightnessUp, spawn, {.v = kbl_up}},
    {0, XKB_KEY_XF86KbdBrightnessDown, spawn, {.v = kbl_down}},
