...
void resizeapply(Client *c, struct wlr_box geo, int interact) {
  struct wlr_box *bbox;
  struct wlr_box clip;
...
void setup(void) {
  ...
  cursor_mgr = wlr_xcursor_manager_create("Adwaita", 16);
  ...
  wl_list_for_each(c, &clients, link) {
    ...
    if (mw > 0 && i == 0) {
      c->geom = (struct wlr_box){
          .x = m->w.x, .y = m->w.y, .width = mw, .height = m->w.height};
      /*
       ...
       */
      dir = c->geom.width > m->w.height ? WLR_DIRECTION_RIGHT
                                        : WLR_DIRECTION_DOWN;
      /*
      ...
      c->geom = (struct wlr_box){.x = m->w.x + mw,
                                 .y = m->w.y,
                                 .width = m->w.width - mw,
                                 .height = m->w.height};
      /*
      ...
      c->geom = (struct wlr_box){.x = prev->geom.x + prev->geom.width / 2,
                                 .y = prev->geom.y,
                                 .width = prev->geom.width / 2,
                                 .height = prev->geom.height};
      prev->geom = (struct wlr_box){.x = prev->geom.x,
                                    .y = prev->geom.y,
                                    .width = prev->geom.width / 2,
                                    .height = prev->geom.height};
      /*
      ...
      c->geom = (struct wlr_box){.x = prev->geom.x,
                                 .y = prev->geom.y + prev->geom.height / 2,
                                 .width = prev->geom.width,
                                 .height = prev->geom.height / 2};
      prev->geom = (struct wlr_box){.x = prev->geom.x,
                                    .y = prev->geom.y,
                                    .width = prev->geom.width,
                                    .height = prev->geom.height / 2};
      ...
      c->geom = (struct wlr_box){.x = prev->geom.x,
                                 ...
                                 .width = prev->geom.width / 2,
                                 .height = prev->geom.height};
      prev->geom = (struct wlr_box){.x = prev->geom.x + prev->geom.width / 2,
                                    .y = prev->geom.y,
                                    .width = prev->geom.width / 2,
                                    .height = prev->geom.height};
